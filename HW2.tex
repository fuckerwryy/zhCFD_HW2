...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\textwidth]{double-precision_error_analysis_(f(x)=x³).pdf}
    \caption{双精度误差分析：$f(x) = x^3$}
\end{figure}

\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\textwidth]{double-precision_error_analysis_(f(x)=sin(2x)).pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\textwidth]{single-precision_error_analysis_(f(x)=x³).pdf}
    \caption{单精度误差分析：$f(x) = x^3$}
\end{figure}

\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\textwidth]{single-precision_error_analysis_(f(x)=sin(2x)).pdf}
